...
public class ModFeatures {
    ...
    public static void placeFeaturesInBiomes() {
        ...
        modification
                ...
                .add(
                        ModificationPhase.ADDITIONS,
                        BiomeSelectors.tag(ModBiomeTags.HAS_ROSE_QUARTZ_GEODE),
                        modifier(
                                ModPlacedFeatures.ROSE_QUARTZ_GEODE,
                                GenerationStep.Feature.UNDERGROUND_DECORATION,
                                MoreGeodes.CONFIG.generateRoseQuartzGeodes()
                        )
                )
                .add(
                        ModificationPhase.ADDITIONS,
                        BiomeSelectors.tag(ModBiomeTags.HAS_EXTRA_ROSE_QUARTZ_GEODES),
                        modifier(
                                ModPlacedFeatures.ROSE_QUARTZ_GEODE_EXTRA,
                                GenerationStep.Feature.UNDERGROUND_DECORATION,
                                MoreGeodes.CONFIG.generateRoseQuartzGeodes()
                        )
                )
                ...
                .add(ModificationPhase.ADDITIONS,
                        BiomeSelectors.tag(ModBiomeTags.HAS_PEARL_GEODE),
                        modifier(
                                ModPlacedFeatures.PEARL_GEODE,
                                GenerationStep.Feature.UNDERGROUND_DECORATION,
                                MoreGeodes.CONFIG.generatePearlGeodes()
                        ));
    }
