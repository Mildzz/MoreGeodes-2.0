...
public class ModItems {
    ...
    public static final Item ROSE_QUARTZ_CRYSTAL_BLOCK = new BlockItem(ModBlocks.ROSE_QUARTZ_CRYSTAL_BLOCK, new FabricItemSettings());

    public static final Item ROSE_QUARTZ_TINTED_GLASS = new BlockItem(ModBlocks.ROSE_QUARTZ_TINTED_GLASS, new FabricItemSettings());
    public static final Item LAPIS_TINTED_GLASS = new BlockItem(ModBlocks.LAPIS_TINTED_GLASS, new FabricItemSettings());
    public static final Item EMERALD_TINTED_GLASS = new BlockItem(ModBlocks.EMERALD_TINTED_GLASS, new FabricItemSettings());

    public static final Item BUDDING_ROSE_QUARTZ = new BlockItem(ModBlocks.BUDDING_ROSE_QUARTZ, new FabricItemSettings());

    public static final Item SMALL_ROSE_QUARTZ_BUD = new BlockItem(ModBlocks.SMALL_ROSE_QUARTZ_BUD, new FabricItemSettings());
    public static final Item MEDIUM_ROSE_QUARTZ_BUD = new BlockItem(ModBlocks.MEDIUM_ROSE_QUARTZ_BUD, new FabricItemSettings());
    public static final Item LARGE_ROSE_QUARTZ_BUD = new BlockItem(ModBlocks.LARGE_ROSE_QUARTZ_BUD, new FabricItemSettings());
    public static final Item ROSE_QUARTZ_CLUSTER = new BlockItem(ModBlocks.ROSE_QUARTZ_CLUSTER, new FabricItemSettings());

    public static final Item ROSE_QUARTZ_SHARD = new Item(new FabricItemSettings());

    public static final Item BUDDING_BISMUTH_BLOCK = new BlockItem(ModBlocks.BUDDING_BISMUTH_BLOCK, new FabricItemSettings());
    public static final Item BISMUTH_BLOCK = new BlockItem(ModBlocks.BISMUTH_BLOCK, new FabricItemSettings());
    public static final Item BISMUTH_CLUSTER = new BlockItem(ModBlocks.BISMUTH_CLUSTER, new FabricItemSettings());
    public static final Item SMALL_BISMUTH_BUD = new BlockItem(ModBlocks.SMALL_BISMUTH_BUD, new FabricItemSettings());
    public static final Item MEDIUM_BISMUTH_BUD = new BlockItem(ModBlocks.MEDIUM_BISMUTH_BUD, new FabricItemSettings());
    public static final Item LARGE_BISMUTH_BUD = new BlockItem(ModBlocks.LARGE_BISMUTH_BUD, new FabricItemSettings());

    public static final Item PEARL_CRYSTAL_BLOCK = new BlockItem(ModBlocks.PEARL_CRYSTAL_BLOCK, new FabricItemSettings());

    public static final Item BUDDING_PEARL = new BlockItem(ModBlocks.BUDDING_PEARL, new FabricItemSettings());

    public static final Item SMALL_PEARL_BUD = new BlockItem(ModBlocks.SMALL_PEARL_BUD, new FabricItemSettings());
    public static final Item MEDIUM_PEARL_BUD = new BlockItem(ModBlocks.MEDIUM_PEARL_BUD, new FabricItemSettings());
    public static final Item LARGE_PEARL_BUD = new BlockItem(ModBlocks.LARGE_PEARL_BUD, new FabricItemSettings());
    public static final Item PEARL_CLUSTER = new BlockItem(ModBlocks.PEARL_CLUSTER, new FabricItemSettings());
    ...
    public static final Item ROSE_QUARTZ_HELMET = new ArmorItem(ModArmorMaterials.ROSE_QUARTZ, ArmorItem.Type.HELMET, new FabricItemSettings());
    public static final Item ROSE_QUARTZ_CHESTPLATE = new ArmorItem(ModArmorMaterials.ROSE_QUARTZ, ArmorItem.Type.CHESTPLATE, new FabricItemSettings());
    public static final Item ROSE_QUARTZ_LEGGINGS = new ArmorItem(ModArmorMaterials.ROSE_QUARTZ, ArmorItem.Type.LEGGINGS, new FabricItemSettings());
    public static final Item ROSE_QUARTZ_BOOTS = new ArmorItem(ModArmorMaterials.ROSE_QUARTZ, ArmorItem.Type.BOOTS, new FabricItemSettings());
    ...
    public static void registerItems() {
        ...
        register("rose_quartz_shard", ROSE_QUARTZ_SHARD);
        ...
        register("rose_quartz_helmet", ROSE_QUARTZ_HELMET);
        register("rose_quartz_chestplate", ROSE_QUARTZ_CHESTPLATE);
        register("rose_quartz_leggings", ROSE_QUARTZ_LEGGINGS);
        register("rose_quartz_boots", ROSE_QUARTZ_BOOTS);
