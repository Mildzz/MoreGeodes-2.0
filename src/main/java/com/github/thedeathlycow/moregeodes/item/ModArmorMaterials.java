...
public enum ModArmorMaterials implements ArmorMaterial {
    ROSE_QUARTZ("rose_quartz", 25, new int[] {3, 8, 6, 3}, 19,
            GeodesSoundEvents.ITEM_ARMOR_EQUIP_ROSE_QUARTZ, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.ROSE_QUARTZ_SHARD));
    ...
    public String getName() {
        return MoreGeodes.MODID + ":" + this.name;
    }
