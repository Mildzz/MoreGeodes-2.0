...
public class GeodesSoundEvents {
    ...
    public static final SoundEvent BLOCK_ROSE_QUARTZ_CRYSTAL_BLOCK_CHIME = GeodesSoundEvents.of("block.geodes.rose_quartz_block.chime");
    public static final SoundEvent BISMUTH_BLOCK_CHIME = GeodesSoundEvents.of("block.geodes.bismuth_block_chime");
    public static final SoundEvent PEARL_CRYSTAL_BLOCK_CHIME = GeodesSoundEvents.of("block.geodes.pearl_crystal_block_chime");
    public static final SoundEvent ITEM_ARMOR_EQUIP_ROSE_QUARTZ = GeodesSoundEvents.of("item.geodes.equip_rose_quartz");
    ...
    public static void registerSoundEvents() {
        ...
        register(BISMUTH_BLOCK_CHIME);
        register(PEARL_CRYSTAL_BLOCK_CHIME);
