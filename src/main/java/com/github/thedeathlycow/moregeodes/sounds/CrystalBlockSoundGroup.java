...
public record CrystalBlockSoundGroup(
    ...
    public static final CrystalBlockSoundGroup ROSE_QUARTZ = new CrystalBlockSoundGroup(
            SoundEvents.BLOCK_AMETHYST_BLOCK_HIT,
            GeodesSoundEvents.BLOCK_ROSE_QUARTZ_CRYSTAL_BLOCK_CHIME
    );

    public static final CrystalBlockSoundGroup BISMUTH = new CrystalBlockSoundGroup(
            SoundEvents.BLOCK_AMETHYST_BLOCK_HIT,
            GeodesSoundEvents.BISMUTH_BLOCK_CHIME
    );

    public static final CrystalBlockSoundGroup PEARL = new CrystalBlockSoundGroup(
            SoundEvents.BLOCK_AMETHYST_BLOCK_HIT,
            GeodesSoundEvents.PEARL_CRYSTAL_BLOCK_CHIME
    );
}
