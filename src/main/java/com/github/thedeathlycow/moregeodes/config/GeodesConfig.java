...
public final class GeodesConfig {
    ...
    private static final String generateRoseQuartzGeodes = "generate_rose_quartz_geodes";
    private static final String generateBismuthGeodes = "generate_bismuth_geodes";
    private static final String generatePearlGeodes = "generate_pearl_geodes";
    ...
    public boolean generateRoseQuartzGeodes() {
        return Boolean.parseBoolean(properties.getProperty(generateRoseQuartzGeodes));
    }
    ...
    public boolean generatePearlGeodes() {
        return Boolean.parseBoolean(properties.getProperty(generatePearlGeodes));
    }
    ...
    private void loadDefaultConfig() {
        ...
        defaultProperties.setProperty(generateRoseQuartzGeodes, "true");
        defaultProperties.setProperty(generatePearlGeodes, "true");
    }
